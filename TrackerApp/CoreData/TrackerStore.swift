...
final class TrackerStore: NSObject {
    ...
    func getTracker(from coreData: TrackerCoreData) throws -> Tracker {
        ...
        let schedule = WeekDays.decode(from: scheduleString)
        return Tracker(
            id: id,
            color: color,
            text: text,
...
extension TrackerStore: TrackerStoreProtocol {
    ...
    func addTracker(_ tracker: Tracker, with category: TrackerCategory) throws {
        ...
        trackerCoreData.trackerSchedule = WeekDays.code(tracker.schedule)
    ...
    func updateTracker(_ tracker: Tracker, with newData: Tracker) throws {
        ...
        trackerCoreData?.trackerSchedule = WeekDays.code(newData.schedule)
        trackerCoreData?.category = categoryCoreData
        try context.save()
    }
